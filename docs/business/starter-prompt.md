...
I want to build a simple whiteboard app that allows someone to log in and quickly create mind maps, user flows, etc and be able to save and have as many as they want.

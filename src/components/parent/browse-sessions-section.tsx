...
import { Calendar, ArrowRight, Users as UsersIcon } from "lucide-react";
...
interface BrowseSessionsSectionProps {
    sessions: SessionWithCounts[];
    childrenList: Child[];
}

export function BrowseSessionsSection({
    sessions,
    childrenList,
}: BrowseSessionsSectionProps) {
    ...
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {displayedSessions.map((campSession) => {
            ...
            {hasMore && (
                <div className="flex justify-center">
                    ...
                    >
                        ...
                        <ArrowRight className={`h-4 w-4 ml-2 transition-transform ${showAll ? "rotate-180" : ""}`} />
                    </Button>
                </div>
            )}
        </div>
